...
### FREDAG | 2022-01-28
 ...
 ### MÅNDAG | 2022-01-31
 Morgonmöte kl 9 och genomgång av vad vi gjort i helgen, pushade och hämtade på Github. Vi kom överens om att responsiviteten är svår att lösa i våra tabeller på CartPage och OrderPage då dessa tabeller är hämtade från MUI och att vi löser det genom att göra tabellerna själva med div:ar och table. Jag började med OrderPage men ingenting fungerade och jag kände otrolig frustration och uppgivenhet. Jag försökte få ordning på detta fram till lunch, men jag fick mest lösa buggar och fel. Vid kl 13 återträffades vi och då sa jag att jag inte mår bra och tog en paus med promenad. Vid kl 14.30 träffades vi igen och tittade lite på vad jag gjort och Linda var gullig och lyfte och puttade mig i rätt riktning. Dessutom upptäckte vi att Stripe inte fungerar längre!?!?!? Hur löser vi det? Vi sparar den frågan till imorgon. Jag fortsatte resten av dagen med OrderPage sidan och det började komma dig vi tänkt oss. 

 ### TISDAG | 2022-02-01
 Satt en stund på morgonen och började med Allmänna villkor som blivit kvar och jag hann ungefär hälften och fortsätter senare. Kl 09 möttes vi upp med ett morgonmöte med push och hämtning från GitHub. Vi tittade igenom issues som är kvar att göra och fortsatte med enskilt arbete och bestämde för att vi skulle sitta tillsammans efter lunch och försöka lösa kategorier och filtrering. Jag fick tillbaka Cartpage då Linda hade gjort lite ändringar i stylingen, men att funktionerna (räkna ihop) inte funkade. Jag fixade (igen) att man kan lägga till och ta bort i varukorgen på varje rad. Och jag la även tillbaka knapparna för "Fortsätt handla" med länk till "userhomepage" och "Töm varukorgen" - funktionen ej klar. Jag fick inte ordning på all styling och lämnade över det till Linda. Därefter fortsatte jag med OrderPage sidan och fick kolumner, rubriker och data på rätt ställe - här är kvar att styla, få in en "colaps" och få den responsive. Blev inte riktigt klar till lunch utan fortsätter vi senare tillfälle. Efter lunch hade vi lite liveshare i Visual Studio och försökte få till filter av kategorier för att få ut "rätt" produkter, det är svårt att hitta rätt men jag tror vi nästan är klara... som med många utmaninger, men vi lyckas klara det på nåt vis. Vi fortsätter med kategorierna vi senare tillfälle. Linda hade före lunch gjort en lösning på cookies, men när jag hämtade den koden så fungerar den inte hos mig. Just nu vet vi inte varför, eftersom det fungerar hos Linda. - Så frustrerande. Vi avslutade dagen med att titta på våra github issues, trello och Henric checklista och inser att vi har lite kvar men att vi imorgon går igenom hela applikationen. Lite kvällsarbete blir det nog också, måste göra färdigt Allmänna villkor och komma vidare på OrderPage. 

 ### ONSDAG | 2022-02-02
 Morgonmöte kl 09.15, på mitt initiativ då jag ville göra klart Allmänna villkor innan vi startade dagen. Och det var det sista som skulle in i vår footer på startsidan. Fixade senare under dagen även att skrollningen funkade och storleken på modalerna. På mötet tittade vi igenom vad som är kvar att göra och använder Henrics checklista för att inte glömma något. Vi gjorde några nya issus på github för att inte tappa dessa i glömska. Vi känner att vi börjar närma oss MEN det känns fortfarande lite läskigt att få klart och att få med allt som behövs. Jag fortsatte sedan att styla orderPage för att hitta rätt responsivitet och jag tror jag är på rätt väg. Eftermiddagen ägnade jag åt loggningen av vårt projekt och uppdaterade burndown-diagrammet inför rapportinlämning på fredag. Vår plan var att sitta med rapporten tillsammans under eftermiddagen, men vi fick tänka om för att "släcka" några bränder. Nu behöver jag en paus (16.19), lite fysisk aktivitet för att sedan ta ett lite kvällspass. Imorgen är en stor dag, då måste bitarna falla på plats och vi ska hinna förbereda en presentation. 

### TORSDAG | 2022-02-03
Appen klar och uppladdad på MissHOsting - presentationen förberedd och klar - rapporten färdigställs.